...
export default function Component() {
  ...
  return (
    <div
      className="relative min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 md:p-8"
      ref={faqRef}
    ...
    >
      ...
      <div className="w-full max-w-4xl space-y-4 sm:space-y-6">
        {faqItems.map((item) => (
          <div key={item.id} className="border-b border-[#9ACD32] pb-4 sm:pb-6">
            <button
